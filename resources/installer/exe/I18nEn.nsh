...
LangString strClientSectionDescription ${LANG_ENGLISH} "Web Server - lsFusion Client ${LSFUSION_VERSION} (Web & Desktop)"
LangString strDesktopClientSectionDescription ${LANG_ENGLISH} "Desktop Client - lsFusion Desktop Client ${LSFUSION_VERSION}"
