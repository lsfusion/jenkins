...
//    }
    ...
    dir(Paths.apt) {
        sh "sudo sh -c 'reprepro --keep-old -vv -b $repoSubdir/ includedeb all server/lsfusion$majorVersion-server_${aptVersion}_all.deb; reprepro --keep-old -vv -b $repoSubdir/ includedeb all client/lsfusion$majorVersion-client_${aptVersion}_all.deb'"
